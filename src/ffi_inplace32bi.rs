...
const _: () = {
    ["Size of KangarooTwelve_InstanceStruct"]
        [::std::mem::size_of::<KangarooTwelve_InstanceStruct>() - 440usize];
    ...
    ["Offset of field: KangarooTwelve_InstanceStruct::blockNumber"]
        [::std::mem::offset_of!(KangarooTwelve_InstanceStruct, blockNumber) - 420usize];
    ["Offset of field: KangarooTwelve_InstanceStruct::queueAbsorbedLen"]
        [::std::mem::offset_of!(KangarooTwelve_InstanceStruct, queueAbsorbedLen) - 424usize];
    ["Offset of field: KangarooTwelve_InstanceStruct::phase"]
        [::std::mem::offset_of!(KangarooTwelve_InstanceStruct, phase) - 428usize];
    ["Offset of field: KangarooTwelve_InstanceStruct::securityLevel"]
        [::std::mem::offset_of!(KangarooTwelve_InstanceStruct, securityLevel) - 432usize];
};
